...
public class DialogUtils {
     ...
     */
    public static void showDialogPrompt(AppCompatActivity activity, String title, String message, String positiveButtonText, String negativeButtonText, boolean isCancellable, final DialogActionListener dialogActionListener) {
     ...
     * @param negativeButtonText
     */
    public static void showMessageDialog(AppCompatActivity activity, String title, String message, String negativeButtonText) {
     ...
     * @param dialogActionListener
     */
    public static void showActionDialog(AppCompatActivity activity, String title, String message, String positiveButtonText, DialogActionListener dialogActionListener) {
     ...
     * @param dialogActionListener
     */
    private static void showDialog(AppCompatActivity activity, String title, String message, String positiveButtonText, String negativeButtonText, boolean isCancellable, final DialogActionListener dialogActionListener) {
        if (activity != null) {
     ...
     */
    public static ProgressDialog showProgressDialog(AppCompatActivity activity, String message, boolean isCancellable) {
