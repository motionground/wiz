package com.wizimatic.appwebber.data.constant;
...
public class AppConstant {
    ...
    public static final String CALL_NUMBER = "08036483844"; // replace by your support number

    public static final String SMS_NUMBER = "08036483844"; // replace by your support sms number
    public static final String SMS_TEXT = "Send your feedback to improve our service..."; // replace by your message

    public static final String EMAIL_ADDRESS = "info@wizimatic.com.ng"; // replace by your support sms number
