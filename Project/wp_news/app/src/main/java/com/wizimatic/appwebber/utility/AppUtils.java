...
public class AppUtils {
    ...
    public static void tapToExit(AppCompatActivity activity) {
...
//NEW NETWORK SETTINGS //
    ...
    public static void youtubeLink(AppCompatActivity activity) {
        updateLink(activity, activity.getString(R.string.youtube_url));
    }

    public static void faceBookLink(AppCompatActivity activity) {
        try {
    ...
    public static void twitterLink(AppCompatActivity activity) {
        try {
    ...
    private static void updateLink(AppCompatActivity activity, String text) {
    ...
    public static void rateThisApp(AppCompatActivity activity) {
        try {
    ...
    public static void appClosePrompt(final AppCompatActivity activity) {
    ...
    public static void makePhoneCall(AppCompatActivity activity, String phoneNumber) {
        if (phoneNumber != null) {
    ...
    public static void sendSMS(AppCompatActivity activity, String phoneNumber, String text) {
        if (phoneNumber != null) {
    ...
    public static void sendEmail(AppCompatActivity activity, String email, String subject, String body) {
        if (email != null) {
    ...
    public static void invokeMessenger(AppCompatActivity activity) {
        try {
