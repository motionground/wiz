...
public class newfontTextView1 extends androidx.appcompat.widget.AppCompatTextView {

    private final Context context;
    private AttributeSet attrs;
    private int defStyle;

    public newfontTextView1(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public newfontTextView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        this.attrs = attrs;
        init();
    ...
    public newfontTextView1(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        Typeface regularFont = Typeface.createFromAsset(getContext().getAssets(), "fonts/newfont.ttf");
