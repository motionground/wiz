...
public class WriteACommentFragment extends DialogFragment {
    ...
    public interface OnCompleteListener {
        void onComplete(Boolean isCommentSuccessful, CommentsAndReplies commentsAndReplies);
    }
