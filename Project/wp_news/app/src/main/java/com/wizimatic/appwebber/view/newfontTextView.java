...
public class newfontTextView extends androidx.appcompat.widget.AppCompatTextView {
...
public newfontTextView(Context context, AttributeSet attrs, int defStyle) {
...
private void init() {
        Typeface regularFont = Typeface.createFromAsset(getContext().getAssets(), "fonts/newfont.otf");
        Typeface boldFont = Typeface.createFromAsset(getContext().getAssets(), "fonts/newfont.otf");
